        ...
        <div className="flex gap-5">
          <div className="flex w-[81px] flex-col gap-2">
            <select
              ...
              id="firstname"
              placeholder="Enter first name"
              className="rounded-lg bg-richblack-700 p-3 text-[16px] leading-[24px] text-richblack-5 shadow-[0_1px_0_0] shadow-white/50 placeholder:text-richblack-400 focus:outline-none text-black"
