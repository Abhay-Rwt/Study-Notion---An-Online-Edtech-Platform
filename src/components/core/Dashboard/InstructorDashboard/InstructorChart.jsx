        ...
        <div className="flex flex-1 flex-col gap-y-4 rounded-md bg-gray-800 p-6">
            ...
            <div className="space-x-4 font-semibold">
                ...
                <button
                    ...
                    className={`rounded-md p-1 px-3 transition-all duration-200 ${currChart === "students"
                ...
                <button
                    ...
                    className={`rounded-md p-1 px-3 transition-all duration-200 ${currChart === "income"
                            ? "bg-gray-700 text-yellow-300"
                            : "text-yellow-400"
                        }`}
                >
