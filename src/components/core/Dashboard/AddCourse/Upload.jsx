    ...
    return (
        <div className="flex flex-col space-y-2">
            ...
            <div
                ...
                rounded-md border-2 border-dotted border-gray-500`}
            >
                <input {...getInputProps()} />
                ...
                {previewSource ? (
                    ...
                    <div className="flex w-full flex-col items-center p-6">
                        ...
                        <p className="mt-2 max-w-[200px] text-center text-sm text-gray-200">
                            ...
                            <span className="font-semibold text-yellow-200">Browse</span>
                        </p>
                        <ul className="mt-10 flex list-disc justify-between space-x-12 text-xs text-gray-200">
