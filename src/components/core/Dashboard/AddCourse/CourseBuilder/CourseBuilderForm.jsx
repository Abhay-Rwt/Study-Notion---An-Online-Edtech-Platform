            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <div className="flex flex-col space-y-2">
                    ...
                    <input
                        ...
                        className="form-rounded-lg bg-gray-700 p-3 text-[16px] leading-[24px] text-gray-50 shadow-[0_1px_0_0] shadow-white/50 placeholder:text-gray-400 focus:outline-none w-full"
                    />
                    {errors.sectionName && (
                ...
                <div className="flex items-end gap-x-4">
                    <IconBtn
                        ...
                        outline={true}
                    >
                        <IoAddCircleOutline size={20} className="text-yellow-200" />
                    </IconBtn>
                    {editSectionName && (
                        <button
                            type="button"
