        ...
        >
            ...
            <div className="flex flex-col space-y-2">
                ...
                <input
                    ...
                    className="rounded-lg bg-gray-700 p-3 text-[16px] leading-[24px] text-gray-50 shadow-[0_1px_0_0] shadow-white/50 placeholder:text-gray-400 focus:outline-none w-full"
                />
                {errors.courseTitle && (
            ...
            <div className="flex flex-col space-y-2">
                ...
                <textarea
                    ...
                    className="rounded-lg bg-gray-700 p-3 text-[16px] leading-[24px] text-gray-50 shadow-[0_1px_0_0] shadow-white/50 placeholder:text-gray-400 focus:outline-none resize-x-none min-h-[130px] w-full"
                />
            ...
            <div className="flex flex-col space-y-2">
                ...
                <div className="relative">
                    <input
                        ...
                        className="rounded-lg bg-gray-700 p-3 text-[16px] leading-[24px] text-gray-50 shadow-[0_1px_0_0] shadow-white/50 placeholder:text-gray-400 focus:outline-none w-full !pl-12"
                    />
