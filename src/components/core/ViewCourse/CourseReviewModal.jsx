...
const CourseReviewModal = ({setReviewModal}) => {
    ...
    // on clicking submit button handler.....
                    ...
                    >
                        ...
                        <div className="flex w-11/12 flex-col space-y-2">
                            ...
                            <textarea
                                ...
                                className="form-rounded-lg bg-gray-700 p-3 text-[16px] leading-[24px] text-gray-50 shadow-[0_1px_0_0] shadow-white/50 placeholder:text-gray-400 focus:outline-none resize-x-none min-h-[130px] w-full"
                            />
